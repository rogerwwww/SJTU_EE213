...
//Task priority
volatile uint8_t task_1_pri = 5, task_2_pri = 5, task_1_pressed_flag = 0;
volatile uint8_t task_3_pri = 5, mask_pri = 6, task_2_pressed_flag = 0;
		...
		if (systick_100ms_status)
		{
			...
			switch ((GPIO_PIN_0 | GPIO_PIN_1) ^ gpio_read_result)
			{
				case (GPIO_PIN_0 | GPIO_PIN_1):
					mask_pri = (task_1_pri > task_2_pri? task_2_pri : task_1_pri);
					task_1_pressed_flag = 1;
					task_2_pressed_flag = 1;
					break;
				case (GPIO_PIN_0):
					mask_pri = task_1_pri;
					task_1_pressed_flag = 1;
					task_2_pressed_flag = 0;
					break;
				case (GPIO_PIN_1):
					mask_pri = task_2_pri;
					task_1_pressed_flag = 0;
					task_2_pressed_flag = 1;
					break;
				default:
					task_1_pressed_flag = 0;
		...
		if (uart_command_status)
		{
			...
			if(!strncmp((char *)uart_receive_buffer, "TASK", 4) && uart_receive_buffer[4] > '0' && uart_receive_buffer[4] < '4')
			{
				if (!strcmp((char *)(uart_receive_buffer + 5), "+START"))
				{
					...
					{
						case 1: task_1_pri = 5; break;
						case 2: task_2_pri = 5; break;
						default: task_3_pri = 5;
					}
				}
				else if(!strcmp((char *)(uart_receive_buffer + 5), "+STOP"))
				{
					switch(uart_receive_buffer[4] - '0')
					{
						case 1: task_1_pri = 7; break;
						case 2: task_2_pri = 7; break;
						default: task_3_pri = 7;
					}
				}
					...
					&& uart_receive_buffer[15] >= '0' && uart_receive_buffer[15] <= '5')
				{
					switch(uart_receive_buffer[4] - '0')
					{
						case 1: task_1_pri = (uart_receive_buffer[15] - '0'); break;
						case 2: task_2_pri = (uart_receive_buffer[15] - '0'); break;
						default: task_3_pri = (uart_receive_buffer[15] - '0');
					}
				}
				else 
					goto invalid_command;
			...
			{
				invalid_command: 
				UARTStringPut((uint8_t *)"INVALID COMMAND!\r\n");
			}
			buffer_pointer = 0;
		}
	}
...
void SysTick_Handler(void)
{
	...
	{
		systick_100ms_couter	= SYSTICK_FREQUENCY/10 - 1;
	...
	{
		systick_5ms_couter		= SYSTICK_FREQUENCY/200 - 1;
